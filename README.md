...
2. Clone the repo
   ```sh
   git clone https://github.com/CYCLOP5/repo_name.git
   ```
...
See the [open issues](https://github.com/CYCLOP5/repo_name/issues) for a full list of proposed features (and known issues).
